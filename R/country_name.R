...
#' @param drop_levels Garder les pays en trop ? par défaut, FALSE
#'
#' @export


country_name <- function(list, from = c("name_fr", "name_en", "name_de", "iso2", "iso3"), to = c("name_fr", "name_en", "name_de", "iso2", "iso3"), drop_levels = FALSE) {
